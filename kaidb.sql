...
CREATE DATABASE IF NOT EXISTS `format` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
USE `format`;
...
CREATE TABLE IF NOT EXISTS `questions_type` (
  `id_questype` int(11) NOT NULL AUTO_INCREMENT,
  `questype` char(50) NOT NULL DEFAULT '0',
  `comment` tinytext DEFAULT NULL,
  `commentVN` tinytext DEFAULT NULL,
...
-- Dumping data for table format.users: ~0 rows (approximately)
DELETE FROM `users`;
